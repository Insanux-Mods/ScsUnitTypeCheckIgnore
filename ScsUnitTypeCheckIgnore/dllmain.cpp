// TruckTester.cpp : Defines the functions for the static library.
//
...
void cleanup()
{
    ...
    VirtualProtect(reinterpret_cast<LPVOID>(g_attribute_type_check_address), 2, PAGE_EXECUTE_READWRITE,
                   &old_acc_protect);
